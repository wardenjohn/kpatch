...
```
Changing the definition in header file may cause too much changes in the object invoked this
macros eventhough we have no changes effect them, which is not a good choice to rewrite the original definition. 
